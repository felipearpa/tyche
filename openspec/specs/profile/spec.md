...
## Purpose
Give the signed-in gambler a Profile screen — reached from the navigation drawer — that shows their avatar (photo or letter fallback) and hosts username editing, and keep the avatar consistent and fresh across the drawer header and toolbar on both platforms.
