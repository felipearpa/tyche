package com.felipearpa.user.login.di
...
import com.felipearpa.user.login.infrastructure.LoginRemoteRepository
import com.felipearpa.user.login.infrastructure.LoginStorageInKeyStore
import dagger.Binds
